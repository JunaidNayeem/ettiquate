      ...
      <Container>
        <Grid container spacing={3}>
            ...
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                >
                  ...
                  <Typography variant="subtitle1" sx={{lineHeight: 3 , mb: 1, color: 'text.disabled' }}>
                  Etiquette Workshops
                  </Typography>
                  <Box
                    sx={{
          ...
          <Grid item xs={12} md={7}>
            ...
            At EmbellisHer PinQ LLC, we understand that there are many options for etiquette education, but here are a few compelling reasons why we stand out and why you should choose us:
